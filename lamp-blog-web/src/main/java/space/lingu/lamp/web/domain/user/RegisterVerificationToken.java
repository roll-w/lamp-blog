...
public record RegisterVerificationToken(
        ...
        boolean used) implements VerifiableToken, DataItem<RegisterVerificationToken> {
    ...
    public static final class Builder implements EntityBuilder<RegisterVerificationToken> {
        private Long id;
