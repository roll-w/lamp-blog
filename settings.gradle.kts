...
include(":lamp-blog-content-service")
include(":lamp-blog-file-awss3")
include(":lamp-blog-content-api")
...
project(":lamp-blog-content-api").projectDir = file("lamp-blog-content/lamp-blog-content-api")
project(":lamp-blog-content-service").projectDir = file("lamp-blog-content/lamp-blog-content-service")
